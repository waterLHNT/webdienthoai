 ...
 <body class="main-bg">
        <div class="login-container text-c animated flipInX">
                    ...
                    <h1 class="text-whitesmoke">Sign Up </h1>
                ...
                <div class="container-content">
                   @if(count($errors) > 0)
                        ...
                        @endif
                    <form class="margin-t" action="{{route('dang-ky')}}" method="post">
                      <input style="color:white" type="hidden" name="_token" value="{{csrf_token()}}" />
                        ...
                        <div class="form-group">
                         ...
                         <br>
                         <div class="form-group">
                            <input type="password" class="form-control" placeholder="Re_password" name="re_password"required="">
                        </div>
                         <br>
                         <div class="form-group">
                         ...
                         <br>
                        <button type="submit" class="form-button button-l margin-b"><p1>Sign Up</p1></button>
                         <br>
        
                        <a class="text-darkyellow" href="#"><p3>Forgot your password?</p3></a>
                        <p class="text-whitesmoke text-center"><small>Do not have an account?</small></p>
                        <a class="text-darkyellow" href="{{route('dang-nhap')}}"><small>Sign In</small></a>
                    </form>
